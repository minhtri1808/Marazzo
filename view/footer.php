                            ...
                            <ul class="toggle-footer">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        <p>QTSC Building 1, Công viên phần mềm Quang Trung, P. Tân Chánh Hiệp, Q.12,
                                            TP.HCM, Việt Nam</p>
                                    </div>
                                </li>
                                <li class="media">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body"> <span><a href="#">mtmusic2015100@gmail.com</a></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-4 no-padding">
                <div class="clearfix payment-methods">
                    <ul>
                        <li><img src="../view/assets/images/payments/1.png" alt=""></li>
                        <li><img src="../view/assets/images/payments/2.png" alt=""></li>
                        <li><img src="../view/assets/images/payments/3.png" alt=""></li>
                        <li><img src="../view/assets/images/payments/4.png" alt=""></li>
                        <li><img src="../view/assets/images/payments/5.png" alt=""></li>
                    </ul>
                </div>
                <!-- /.payment-methods -->
            </div>
...
<script src="https://dochat.vn/code.js?id=9190718220952207037"></script>
