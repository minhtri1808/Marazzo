        ...
        <div class='row'>
                ...
                <div class="sidebar-module-container">
                    <div class="sidebar-filter">
                        ...
                        <div class="sidebar-widget">
                            <h3 class="section-title">Phân loại theo:</h3>
                            ...
                            <div class="sidebar-widget-body">
                                <ul class="list">
                                    <?php
                                    $loadproducer   = loadproductcatalog();
                                    foreach ($loadproducer as $catalog) {
                                        $cata =  loadcatalog($catalog['id_catalog']);
                                        $linksp = "index.php?act=shop&id_catalog=" .  $catalog['id_catalog'];
                                        foreach ($cata as  $cata_) {
                                            echo ' <li><a href="' . $linksp . '">' . $cata_['name'] . '</a></li>';
                                        }
                                    }
                                    ?>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="sidebar-widget-body">
                                <ul class="list">
                                    <?php
                                    $loadproducer   = loadproductnhasx();
                                    foreach ($loadproducer as $producer) {
                                        $nsx =  loadnhasx($producer['id_producer']);
                                        $linksp = "index.php?act=shop&id_producer=" .  $producer['id_producer'];
                                        foreach ($nsx as  $nsx_) {
                                            echo ' <li><a href="' . $linksp . '">' . $nsx_['name'] . '</a></li>';
                                        }
                                    }
                                    ?>
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 rht-col">
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image"> <img src="../view/assets/images/banners/cat-banner-1.jpg" alt="" class="img-responsive">
                        </div>
                                    ...
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            <button data-toggle="dropdown" type="button" class="btn dropdown-toggle">
                                                Sắp xếp theo giá <span class="caret"></span> </button>
                                            <ul role="menu" class="dropdown-menu">
                                                <li role="presentation"><a href="#">position</a></li>
                                                <?php
                                                foreach ($fromto as  $price) {
                                                    $linksp = "index.php?act=shop&rangePrice=" .  $price['rangePrice'];
                                                    echo '<li role="presentation"><a href="' . $linksp . '"> Giá:' . $price['rangePrice'] . 'VNĐ</a></li>';
                                                }
                                                ?>
                                ...
                                <div class="lbl-cnt"> <span class="lbl"></span>
                                    <div class="fld inline">
                                        <form action="index.php" method="get">
                                            ...
                                            <input type="text" name="keyword" placeholder=" Tìm kiếm tại đây" value="<?php echo (isset($_GET['keyword'])) ? $_GET['keyword'] : ''; ?>">
                                            <input style="background: #dbcc8f;border: 1px solid #dbcc8f;color: #fff;" type="submit" value="Tìm kiếm">
                                        </form>
                                    </div>
                                    <!-- /.fld -->
                                </div>
                                            ...
                                            <div class="row product-list-row">
                                                <div class="col col-sm-3 col-lg-3">
                                                    <div class="product-image">
                                                        <div class="image"> <img src="../view/assets/images/products/p3.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- /.product-image -->
                                                </div>
                                                ...
                                                <div class="col col-sm-9 col-lg-9">
                                                    <div class="product-info">
                                                        ...
                                                        <div class="description m-t-10">Suspendisse posuere arcu diam,
                                                            id accumsan eros pharetra
                                                            ac. Nulla enim risus, facilisis bibendum gravida eget,
                                                            lacinia id purus. Suspendisse
                                                            posuere arcu diam, id accumsan eros pharetra ac. Nulla enim
                                                            risus, facilisis bibendum
                                                            gravida eget. Suspendisse posuere arcu diam, id accumsan
                                                            eros pharetra ac. Nulla enim
                                                            risus, facilisis bibendum gravida eget, lacinia id purus.
                                                            Suspendisse posuere arcu diam,
                                                            id accumsan eros pharetra.</div>
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-unstyled">
                                                                    <li class="add-cart-button btn-group">
        ...
        <div id="brands-carousel" class="logo-slider">
            <div class="logo-slider-inner">
                <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                    <div class="item m-t-15"> <a href="#" class="image"> <img data-echo="../view/assets/images/brands/brand1.png" src="../view/assets/images/blank.gif" alt=""> </a>
                    </div>
                    <!--/.item-->

                    <div class="item m-t-10"> <a href="#" class="image"> <img data-echo="../view/assets/images/brands/brand2.png" src="../view/assets/images/blank.gif" alt=""> </a>
                    </div>
                    <!--/.item-->
